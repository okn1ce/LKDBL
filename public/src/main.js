...
function setUpTable () {
  ...
  $credits = $('<div>', {'id': 'credits', 'class': 'info-content'}).html('<p>©2019 LKDCorp, fait par n1ce</p><p>Sons de <a href="https://www.zapsplat.com">zapsplat.com</a> et <a href="http://kenney.nl/">kenney.nl</a></p>');
  $description = $('<div>', {'id': 'description', 'class':'info-content'}).html("<h2>Explication du Blackjack en anglais pcq j'ai la flemme de chercher en francais</h2><br/><p>In Blackjack, players face off against the dealer. The dealer and the players each initially get two cards. The players can only see one of the dealer's cards. The cards are worth face value, except Aces and face cards (J, Q, K), which are 1 or 11 and 10, respectively.</p><br/>"
